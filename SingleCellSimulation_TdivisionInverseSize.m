% One CDK Model with Threshold_division inversely proportional to cell size

% Fixed pCDK 
% CDK production independent of Cell Size
...
% PhaseRecord
        if CDK < Threshold_division * (1/Size);
            Phase = 0;          
        else if CDK >= Threshold_division * (1/Size);
                Phase = 1;
             end
        end
    end                 
