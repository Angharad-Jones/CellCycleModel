% One CDK Model with pCDK dependent on cell size

% Fixed CDK Threshold
% CDK production dependent on Cell Size
...
% by Phase = 0  
    while Phase == 0;
         j = j + 1;
         Size = Size + ( Size * g * 1 );  % Model simulates 1 hour time intervals
         CDK = CDK + (Size * pCDK * 1);
